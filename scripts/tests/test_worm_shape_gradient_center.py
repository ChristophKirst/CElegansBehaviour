...
skel = wgeo.skeleton_from_image_discrete(img, sigma = None, absolute_threshold = None, threshold_factor = 0.85, verbose = True)

grad = wc.cost_func_grad(w, par, skel, epsilon = eps, verbose = True)
print grad
...
for i in range(nsteps):
  ...
  grad = wc.cost_func_grad(w, par_1, skel, epsilon = eps, verbose = True,
                           weight_distances=1);
