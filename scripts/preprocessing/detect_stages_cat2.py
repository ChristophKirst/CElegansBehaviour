...
pks_rmv = {8 : [4,5], 7 : [5], 14: [1], 19 : [3], 37 : [338], 50 : [4], 49 : [4]}
          
pks_add = {3 : [266], 6: [275], 11: [341], 14 : [270], 17 : [258], 19: [464], 22 : [259], 25 : [480], 50 : [375]}
...
add_shift = {4 : 10, 8 : 4, 23: 4,24 : 20,  44: 6, 46 : 4, 33: 10, 34 : 10, 42 : 10}
...
h = np.array([np.nonzero(v_all[wid,hatching_cor[wid]:] > 0.4)[0][0] for wid in range(nworms)]);
