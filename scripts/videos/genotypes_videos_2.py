...
gsAll = gridspec.GridSpec(2,2, left = 0.00, right = 1.0, top = 0.95, bottom = 0, hspace = 0.08, wspace = 0.08);
...
for i,s in enumerate(['N2', 'tph-1', 'npr-1', 'daf-7']):
  if i > 0:
    fs = 'italic';
  else:
    fs = None;
  ...
  plt.annotate(s, (xpos + 0.014, ypos + 0.014) , xycoords = 'figure fraction', verticalalignment= 'center', horizontalalignment = 'left', fontsize = 3.5, fontstyle = fs)
