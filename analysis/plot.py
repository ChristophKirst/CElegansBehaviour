...
def plot_image_array(arrays, names = None, order = None, cmap = 'viridis', invert_y = False, nplots = None):
  if nplots is None:
    nplots = len(arrays);
  for i,d in enumerate(arrays):
    ...
    if invert_y:
      ...
      #e = None;
      o = 'upper';
    plt.imshow(dpl, interpolation = 'none', aspect = 'auto', cmap = cmap, origin = o)
